  ...
  <div class="sip-rs-wrap">
    <div class="sip-container">
      <h2 class="nav-tab-wrapper">
        ...
        <a class="nav-tab<?php if ( isset( $_GET['action'] ) && 'help' == $_GET['action'] ) echo ' nav-tab-active'; ?>" href="admin.php?page=sip-reviews-shortcode-settings&amp;action=help"><?php _e( 'Help', 'sip-social-proof' ); ?></a>
      </h2>
      <?php
        if ( ! isset( $_GET['action'] ) ) {
